...
public class fMahasiswa extends javax.swing.JFrame {
    ...
    public fMahasiswa() throws SQLException {
        ...
        String[] opsiJUR = {"Pilih Jurusan", "KAB", "MTI", "DKV", "TIPAR", "RSK", "BD"};
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(cbJUR, javax.swing.GroupLayout.PREFERRED_SIZE, 136, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void destroyData() throws SQLException {
       ...
       if(!cnn.isClosed()){
           PreparedStatement PS = cnn.prepareStatement("DELETE from mhs set WHERE NIM=?;");
           PS.setString(1, nim);
           PS.executeUpdate();
           cnn.close();
       }
